...
class CategoryOptionsSeeder extends Seeder
{
    ...
    public function run()
    {
        CategoryOptions::create([
            'image'=>'http://kleymabel.by/termo.jpg',
        ...
        CategoryOptions::create([
            'image'=>'http://kleymabel.by/rchka.jpg',
            'h3'=>'Штамп на ручке',
        ...
        CategoryOptions::create([
            'image'=>'http://kleymabel.by/po_derevu2.jpg',
