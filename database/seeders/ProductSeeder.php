...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
            ...
            'short_desc'=>'Фумигационный штамп типа IPPC "Колосок" для нанесения оттисков на поддонах.'
        ]);
        Product::create([
            ...
            <h2 style="text-align: center;">Клеймо для европоддонов</h2>
            
            <p>&nbsp;</p>
            
            <p>&nbsp; &nbsp; &nbsp;Знак &laquo;EUR&raquo; на поддоне означает, что данное изделие произведено в Европе и соответствует всем европейским стандартам. Отжиг &laquo;EUR&raquo; на паллетах обязателен, если необходимо отправлять продукцию в европейские страны. Без данного знака экспорт осуществить невозможно.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Нанесение знака производится посредством отжига. Отгравированное клише разогревается при помощи огня или электричества до температуры выше 300 градусов, после чего прислоняется к дереву. Контакт осуществляется на 5 секунд, после чего получается отжиг. Размер изделия: 100 х 60 мм, сделано из латунного сплава. Использование латуни в качестве материала более оправдано, чем стали. Себестоимость гравировки на стали высока, так как данный материал имеет высокую жесткость. Достичь данной жесткости проще и дешевле при усилении штампа: фиксации на нем металлической пластины. Данная вариация позволяет избежать деформации основания.</p>
            
            <p>&nbsp; &nbsp; &nbsp; Существует альтернатива нанесения: при помощи краски. Такие клейма для тиснения поддонов изготавливаются из резины. Для нанесения основание обмахивается в краску и ставится на паллету. Однако данный способ не обеспечивает сохранного оттиска и не во всех случаях позволяет идентифицировать поддон.</p>
            
            <h2 style="text-align: center;">Как осуществить нагрев</h2>
            
            <p>&nbsp; &nbsp; &nbsp;Для электрического нагрева клейма используют термоустановку или паяльник. Термоустановки имеются двух видов:</p>
            ...
            <p>&nbsp; &nbsp; &nbsp;Совет: паяльник для нагрева данных штампов не подходит. Минимальная мощность нагревателя для разогрева штампов таких размеров - 300 Wt. Такие паяльники оснащены керамическим основанием, которое отличается низким ресурсом. После 50 отжигов керамика трескается, после чего передача тепла снижается в два раза.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Если необходим максимально дешевый вариант нагрева, то клеймо на ручке - идеальный вариант. Нагрев данного клише осуществляется следующим способом:</p>
            
            <ul>
                <li>Изделие берется за ручку</li>
                <li>Подносится к источнику открытого огня</li>
                <li>Нагрев производится 6-8 минут</li>
            </ul>',
            'price'=>114,
            'slug'=>'kleymo_eur',
            'order'=>2,
        ...
        Product::create([
            ...
            <h2 style="text-align: center;">Штамп для паллет с номером партии и датой</h2>
            
            <p>&nbsp;</p>
            
            <p>&nbsp; &nbsp; &nbsp;Фитосанитарное клеймо (IPPC) - размер 80х70мм включает в себя комплект сменных символов.</p>
            
            <ul>
                <li>1. 2х - значный номер партии</li>
                <li>2. Дата</li>
                <li>3. Месяц&nbsp;</li>
                <li>4. Год&nbsp;</li>
            </ul>
            
            <p>&nbsp; &nbsp; &nbsp;Для замены символа (например даты) нужно достать стопочную шпильку, положить в раз нужный символ и установить шпильку обратно, время замены составляет меньше минуты.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Клеймо универсальное , оно легко крепиться к специальным нагревателям для клеймения поддонов НК500 и НК1000&nbsp;</p>
        ...
        Product::create([
            ...
            'product_id'=>1,
            'content'=>'Штамп из металла (латунь). Предназначение: оставление отжигов на паллетах. Для создания отжига данное клеймо требуется нагреть. Существует два вариаента нагрева: электрическое и от открытого огня. Бюджетный вариант - второй. На штамп устанавливается рука. Клеймо держится за ручку и нагревается от пламени. Материал изделия жаростойкий, что предотсращает плавление.',
        ]);
        Product::create([
            ...
            'product_id'=>1,
            'content'=>'Клеймо из латуни, изготавливается под заказ. На изделии гравируется порядковый номер предприятия, осуществляющего клеймение, символика "HT", "DB", осзначающая что поддон просушен и очищен от коры. Важная составляющая гравировки - наличие специального типа "Колосок".'
        ]);
        Product::create([
            ...
            'product_id'=>1,
            'content'=>'Металлические изделия, при помощи которых клеймят поддоны называются фитосанитарными или фумигационными клеймами. Изготавливаются из стали или латуни с глубиной гравировки не менее 2 мм. Для нанесения отжига требуется нагреть клеймо в течение 4-6 минут.'
        ]);
        Product::create([
            ...
            'content'=>'Клейма с закалкой по металлу. Изготавливаются на станке ЧПУ. Термическая обработка для увеличения жесткости. Используются для реализации оттисков на металле.',
            'price'=>135,
        ...
        Product::create([
            ...
            'content'=>'Изготовление клейм для сварщиков по индивидуальным размерам и макетам. Данные изделия используются в промышленных целях для маркировки сварных швов. Индивидуальное клеймо сварщика позволяет определить, каким мастером был реализован шов. Каждому изделию присваивается индивидуальный номер или буквенное обозначение. Для данных изделий производится закалка разных степеней: ударной и бьющей части. Благодаря данной процедуре клеймо сварного шва прослужит долго и не будет откалываться.',
            'price'=>135,
        ...
        Product::create([
            ...
            'content'=>'Устройство для нанесения оттисков для лиц, занимающихся производство не в промышленных маштабах.',
            'price'=>120,
        ...
        Product::create([
            ...
            'content'=>'Оттиск ставится посредством биения. Данный тип клейм закаливается на 57 единиц по шкале Роквелла. Гравирутся любые макеты, возможно изготовление разных диаметров. Наличие закалки - важнейшая составляющая данного изделия. Некаленые клейма быстро изнашиваются.',
            'price'=>120,
        ...
        Product::create([
            ...
            'content'=>'Алфавит ударных клейм / номерные клейма с номерами от 0 до 9',
            'price'=>113,
        ...
        Product::create([
            ...
            'category_id'=>4,
            'short_desc'=>'Сургучная печать, с гравировкой заказчика.',
        ]);
        Product::create([
            'title'=>'Готовые',
        ...
        Product::create([
            ...
            'category_id'=>6,
            'short_desc'=>'Металлическое клише для тиснения изделий.',
        ]);
        Product::create([
        ...
        Product::create([
            'title'=>'Нагреватель клейм и клише НК-500',
        ...
        Product::create([
            'title'=>'Нагреватель клейм и клише НК-1000',
        ...
        Product::create([
            ...
            <h2 style="text-align: center;">Ветеринарный штамп Ветнадзор</h2>
            
            <p>&nbsp;</p>
            
            <p>&nbsp; &nbsp; Клеймо &quot;Ветнадзор&quot; - это латунный штамп овальной формы, предназначенный для клеймения мяса. На штампе имеется надпись &quot;РЕСПУБЛИКА БЕЛАРУСЬ ВЕТНАДЗОР&quot;. Также отгравировывается рамка и 4 пары цифр в центре, которые иденцифицируют город, область и организацию, реализующую мясо.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Данное клеймо считается обязательным, если для реализации продукции из мяса. Данный штамп &quot;Ветнадзор&quot; подтверждает, что санитарная экспертиза была произведена уполномоченным должностным лицом.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Штамп для мяса Ветнадзор изготавливается из латунного сплава с толщиной основания 1,4 СМ. Гравируется на станке ЧПУ мелкими конусообразными фрезами с диаметром основания 0,2 мм. Данная технология позволяет делать оттиск на мясе читаемым, буквы не сливаются.</p>
            
            <p>&nbsp; &nbsp; &nbsp;Клеймение мяса производится методом обмакивания клейма в крастиельный состав, состоящий из эфира, формалина, метилвиолета. Цвет: темно-синий.</p>
            
            <p>&nbsp; &nbsp; Наша организация изготавливает все виды ветеринарных клейм уже более 5 лет. Все размеры, шрифты и рамки соответствуют требованиям ГОСТ.</p>',
            'price'=>100,
