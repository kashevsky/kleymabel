...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create([
            ...
            'description'=>'Ветеринарные штампы',
            'preview_image'=>'images/vetnadzor.jpg',
            'main_image'=>'images/vet1.jpg',
            'content'=>'Ветеринарное клеймо - изделие из латуни или бронзы, предназначенное для маркировки мяса. Маркировка подтверждает пригодность мясных продуктов к употреблению в пищу.
            Согласно постановлению Министерства сельского хозяйства продовольствия РБ на всех видах мяса должен быть обязательный оттиск, который ставится ветеринарными клеймами. Для каждого типа мяса необходимо определенный вид клейма. Клеймение производится после проведения ветеринарного осмотра тушек.
            Клейма должны быть у ответственного лица, имеющего право производить маркировку. Оттиск ставится при помощи красителей состоящих из метилвиолета, формалина и эфира. Для процедуры нанесения маркировки подходит исключительно данный вид краски. Наличие оттиска на мясе подтверждает его пригодность в качестве пищи.
            Виды ветеринарных клейм Существует 4 категории штампов для клеймения мяса:
            Овальное с уникальным номером
            Прямоугольное «Ветслужба»
            Буквенное
            Цифровое
            Овальное
            На овальном штампе изображено три строки цифр:
            Номер, обозначающий конкретную область или город
            Номер, обозначающий район
            Цифровое обозначение предприятия, производящего продукцию
            На клейме имеется надпись «Ветнадзор», выше «Республика Беларусь». Наличие данного оттиска обозначает пригодность конкретной мясной продукции для реализации и употребления.
            Форма данного изделия исключительно овальная. Материал изготовления: латунь, резина, бронза. Для удобства нанесения оснащено металлической ручкой, соединенной со штампом резиновым соединением.
            Прямоугольное
            На данном изделии отгравирована строка «Ветслужба», ниже надпись «Предварительный осмотр», еще ниже группа цифр, идентифицирующих город, область, район и предприятие.
            Данный штамп подтверждает факт того, что животные на убой здоровы. Перед и после убоя был осуществлен осмотр квалифицированным специалистом. Важно учитывать, что данный оттиск не считается подтверждением осуществления реализации мяса. Данное подтверждение актуально только при наличии овального оттиска «Ветнадзор».
            Некоторое мясо требуется обезвреживать. Для маркировки таких туш используются следующие клейма:
            Туберкулез
            Ящур
            Финноз
            На консервы
            На вареную колбасу
            Проварка
            На данных клеймах также указываются порядковые номера предприятия, области и района.
            Изготовление клейм и штампов для мяса
            Главное требование к ветеринарным штампам - точная гравировка с растением между линиями не более 1 мм. Оттиск должен быть читаемым, линии не должны смазываться на туше. Изготавливается на латунном основании шириной 14мм. Гравировка осуществляется на станке с программным обеспечением фрезой 0,2 мм. Фрезеровку требуется осуществлять не широкими граверами, так как это обеспечивает более точную проработку линий.',
            'price'=>'80',
            'engraving_depth'=>'',
            'material'=>'Латунь',
            'width'=>'',
